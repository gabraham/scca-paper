...
these penalties. 
% In addition to canonical correlation analysis of multiple
%quantitative phenotypes, fast sparse partial least squares (sparse PLS)
%can be performed by using a single phenotype ($\mathbf{Y}$ having one column).
