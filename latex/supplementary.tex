...
%we
%#used a normally-distributed~$\mathcal{N}(0,1)$ vector of variates
%to initialise $v_1$.
%We also explored initialising $v_1$ by using
...
%but we did not observe a large effect on the number
